...
<head>
    ...
    <title>Inativar de Usuários</title>
        ...
        <form action="classes/controller/UsersController.php" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <input type="text" id="login" name="inputLogin" class="form-control" value="<?php echo $consulta['login']; ?>" disabled>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <label for="senha"><b>Senha:</b></label>
                    <input type="password" id="senha" name="inputSenha" class="form-control" value="<?php echo $consulta['senha']; ?>" disabled>
                </div>
                <div class="col-sm-4">
                    <label for="confsenha"><b>Confirme a Senha:</b></label>
                    <input type="password" id="confsenha" name="inputConfsenha" class="form-control" value="<?php echo $consulta['senha']; ?>" disabled>
                </div>
                <div class="col-sm-4">
                    <label for="perfil"><b>Perfil:</b></label>
                    <select class="form-select" aria-label="Default select example" name="inputPerfil" disabled>
                        <?php
                ...
                <input type="hidden" name="inativo" value="<?php echo "N"; ?>" />
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="submit" class="btn btn-danger" value="Inativar" name="btnInativarUsers" style="width: 30% ;">
                        <input type="submit" class="btn btn-success" value="Ativar" name="btnAtivarUsers" style="width: 30% ;">
                    </div>
                </div>
            </div>
        </form>
