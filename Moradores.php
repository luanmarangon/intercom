        ...
        <form action="classes/controller/MoradoresController.php" method="POST">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="text" id="nome" name="inputNome" class="form-control" require>
                </div>
                <div class="col-sm-2">
                    <label for="cpf"><b>C.P.F.:</b></label>
                    <input type="cpf" id="cpf" name="inputCpf" class="form-control">
                </div>
                <div class="col-sm-2">
                    <label for="telefone"><b>Telefone:</b></label>
                    <input type="text" id="telefone" name="inputTelefone" class="form-control">
                </div>
                <div class="col-sm-2">
                    <label for="celular"><b>Celular:</b></label>
                    <input type="celular" id="celular" name="inputCelular" class="form-control" require>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <label for="email"><b>E-Mail:</b></label>
                    <input type="email" id="email" name="inputEmail" class="form-control" require>
                </div>
                <div class="col-sm-4">
                    <label for="senha"><b>Senha de Acesso:</b></label>
                    <input type="password" id="password" name="inputSenha" class="form-control" require>
                </div>
                ...
                <div class="col-sm-4">
                <br>
                    <input type="submit" class="btn btn-primary btn-lg" value="Cadastrar" name="btnCadastrarMoradores">
