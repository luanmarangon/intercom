        ...
        <form action="classes/controller/UsersController.php" method="POST">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <h4 style="text-align: center;">Acesso Moradores</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <label for="login" class="form-label">E-mail:</label>
                    <input type="mail" class="form-control" id="login" aria-describedby="Login" name="inputLogin" required placeholder="Informe seu E-Mail">
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <label for="password" class="form-label">Senha:</label>
                    <input type="password" class="form-control" id="password" aria-describedby="Password" name="inputPassowrd" required placeholder="Informe sua Senha">
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 offset-md-4">
                ...
                <div class="col-md-4 offset-md-4" style="text-align: right;">
                    <a href="../intercom/EsqueciSenha.php">Esqueceu sua Senha?</a>
                </div>
            </div>
        </form>
        <div class="row">
