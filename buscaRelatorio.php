...
<body>
    <?php include("nav.php"); ?>
    <br>
    <h3 style="text-align: center;">Relatórios de Ramais</h3>
    ...
    <div class="row">
        <form action="" method="GET">
            <div class="col-3">
                ...
                <select name="selectCondominio" id="selectCond" class="form-select" aria-label="Select Condominios">
    ...
    <div class="row">
        <div class="col">
            <table id="tabela" class="table table-hover">
                ...
                <?php
                // echo $_GET['selectCondominio'];
                //         include("classes/dao/RelatoriosDAO.class.php");
                //         $objDAO = new RelatoriosDAO();
                //         $consulta1 = $objDAO->relcondominio($_GET['selectCondominio']);
                //         var_dump($consulta1['nome']);
                        // while ($linha = $consulta1->fetch(PDO::FETCH_ASSOC)) {
                        //     echo "<tr>
						// 			<td>" . $linha1["nome"] . "</td>
						// 			<td>{$linha1['matricula']}</td>
						// 			<td>{$linha1['cpf']}</td>
						// 			<td>{$linha1['telefone']}</td>
						// 			<td>{$linha1['Funcao_has_Setor_Funcao_codigo']}</td>
						// 			<td>{$linha1['Funcao_has_Setor_Setor_codigo']}</td>
