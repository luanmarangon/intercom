...
<body>
    <?php include("nav.php"); ?>
    <br>
    <h3 style="text-align: center;">Moradores</h3>
    ...
    <div class="row">
        <div class="col">
            <a href="Moradores.php">
                <input type="button" class="btn btn-outline-primary" name="btn-CadCondominio" value="+ Morador">
            </a>
        </div>
    </div>
    <br>
        ...
        <div class="col">
            <table id="tabela" class="table table-hover">
                ...
                <tbody>
                    ...
                    $consulta = $objDAO->consultarMoradores();
                    while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
                        echo "  <tr>
									...
									<td>{$linha['ativo']}</td>
                                    <td>
                                        <a href='CadastroMoradores.php?id={$linha['id']}'>Cadastro</a> |
                                        <a href='AlterarMoradores.php?id={$linha['id']}'>Alterar</a> 
                                    </td>
								</tr>";
                    }
                    ?>
