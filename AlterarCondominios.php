        ...
        <form action="classes/controller/CondominiosController.php" method="POST">
            ...
            <div class="row">
                <div class="col-sm-2">
                    ...
                    <input type="text" id="prefixo" name="inputPrefixo" class="form-control" value="<?php echo $consulta['prefixo']; ?>">
                </div>
                <div class="col-sm-7">
                    <label for="condominio"><b>Condomínio:</b></label>
                    <input type="text" id="condominio" name="inputCondominio" class="form-control" value="<?php echo $consulta['nome']; ?>">
                </div>
                <div class="col-sm-3">
                    <label for="contato"><b>Contato:</b></label>
                    <input type="text" id="contato" name="inputContato" class="form-control" value="<?php echo $consulta['contato']; ?>">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <input type="telefone" id="telefone" name="inputTelefone" class="form-control" value="<?php echo $consulta['telefone']; ?>">
                </div>
                <div class="col-sm-3">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <input type="submit" class="btn btn-primary btn-lg" value="Alterar" name="btnAltCondominio">
                    <input type="submit" class="btn btn-danger btn-lg" value="Retornar" name="btnAltRetornar">
                </div>
